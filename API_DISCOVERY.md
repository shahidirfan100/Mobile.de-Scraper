...
| Search-page structured pages 1-3 | One Impit `ios18` client, no explicit cookies | HTTP 200 structured payload; semantic filter validation required | 117+ source fields | `pageNumber`, `numPages` | Validated; cookie jar not required |
